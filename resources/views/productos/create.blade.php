...
<h1 class="mt-3 text-2xl font-semibold tracking-tight text-ink-950">Nuevo producto</h1>

<form action="{{ route('productos.store') }}" method="POST" class="mt-6 max-w-2xl rounded-lg border border-ink-950/10 bg-white p-6">
    @csrf
